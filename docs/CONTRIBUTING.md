...
Ready to contribute? Here's how to set up `landcover_assignment` for local development.

1. Download a copy of `landcover_assignment` locally.
2. Install `landcover_assignment` using `poetry`:
