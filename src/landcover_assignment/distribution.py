...
class LandDistribution:
    ...
    def land_distribution(cls, land_use, current_area, new_area):
        ...
        if land_use == "grassland":
            ...
            land["share_organic"] = (
                (land_df["area_ha"].item() * land_df["share_organic"].item()) + new_area
            ) / land["area_ha"]
            land["share_mineral"] = (
                land_df["area_ha"].item() * land_df["share_mineral"].item()
            ) / land["area_ha"]
            land["share_rewetted_in_mineral"] = (
                land_df["area_ha"].item() * land_df["share_rewetted_in_mineral"].item()
            ) / land["area_ha"]
            land["share_rewetted_in_organic"] = (
                (
                    land_df["area_ha"].item()
                    * land_df["share_rewetted_in_organic"].item()
                )
                + new_area
            ) / land["area_ha"]
            land["share_peat_extraction"] = (
                land_df["area_ha"].item() * land_df["share_peat_extraction"].item()
            ) / land["area_ha"]
            ...
            land["share_rewetted_in_mineral"] = land_df[
                "share_rewetted_in_mineral"
            ].item()
            land["share_rewetted_in_organic"] = land_df[
